$(document).ready(function () {
    ...
    function toggle_detail() {
        ...
        //
        //        var menu = $(".toggle-menu  > ul > li");
        //        var submenu = $(".toggle-menu > ul > li > .submenu ");
        ////        var arrow = $(".arrow>span");
        //
        //        menu.click(function (e) {
        //            e.preventDefault();
        //            var target = $(this);
        //            var index = target.index();
        //            menu.removeClass("actived_tab");
        //            target.addClass("actived_tab");
        //            submenu.stop().slideUp(300);
        //            target.find(".submenu").stop().slideDown(300);
        ////            arrow.eq(index).css("display", "none");
        ////            arrow.eq(index).css("display", "block");
        //
        //        })
    ...
    //                num=0
    //            };
    //            $(".vertical-slide-list").stop().animate({
    //                top: result + 'px'
    //            });
    //        }, 2000);
    //
